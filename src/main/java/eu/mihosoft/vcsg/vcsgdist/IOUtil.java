...
class IOUtil {
    ...
    public static String fileToBase64(File file)
            throws FileNotFoundException, IOException {
        return eu.mihosoft.vcsg.vcsgdist.Base64.encodeBytes(fileToByteArray(file));
    }
    ...
    public static byte[] base64ToByteArray(String data) {
        return eu.mihosoft.vcsg.vcsgdist.Base64.decode(data);
    }
...
//    }
    ...
    public static File base64ToTmpFile(String data, String extension) throws IOException {
        ...
        result.deleteOnExit();
        FileOutputStream out = new FileOutputStream(result);
        out.write(eu.mihosoft.vcsg.vcsgdist.Base64.decode(data, eu.mihosoft.vcsg.vcsgdist.Base64.GZIP));
        out.flush();
        out.close();
        return result;
    }
...
//                throw ex;
     ...
     */
    public static void extractDirFromClassPath(ClassLoader classloader,
