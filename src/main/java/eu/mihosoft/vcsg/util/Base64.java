...
/**
 * <p>Encodes and decodes to and from Base64 notation.</p> <p> This code is
 * derived from the work of Robert Harders. Please visit <a
...
class Base64 {
     ...
     * @param off Offset in array where conversion should begin
     * @param len Length of data to convert
     * @param options Specified options, options alphabet type is pulled from
     * this (standard, url-safe, ordered)
     * @see Base64#GZIP
     * @see Base64#DONT_BREAK_LINES
     */
    ...
    public static byte[] decode(String s, int options) {
        ...
        try {
            ...
            System.out.println("BASE64: decode(:,:) catch case");
            bytes = s.getBytes();
        }   // end catch
        //</change>
     ...
     * 
     * @return The decoded and deserialized object of methode 
     *          decodeToObject(String encodedObject, ClassLoader loader)
     *          with loader = null;
     */
    public static Object decodeToObject(String encodedObject) {
        ...
        return decodeToObject( encodedObject, loader);
    }   
     ...
     */
    public static Object decodeToObject(String encodedObject, ClassLoader loader) {
        ...
        try {
            ...
            if (loader == null) {
                ...
                ois = new VObjectInputStream(bais, loader);
            }
     ...
     *
     * @param encodedObject The Base64 data to decode
     * @param oisCls the input stream that shall perform the deserialization
     * @return The decoded and deserialized object
     */
    public static Object decodeToObject(String encodedObject, Class<? extends ObjectInputStream> oisCls) {
        ...
        try {
            bais = new java.io.ByteArrayInputStream(objBytes);
            try {
                constructor = oisCls.getConstructor(java.io.InputStream.class);
            ...
            if (constructor == null) {
                throw new IllegalArgumentException(
                        "Specified ObjectInputStream class does not provide"
                        + " the required constructor: "
                        + "ObjectInputStream(InputStream in)!" );
            }

            try {
                ois = (ObjectInputStream) constructor.newInstance(bais);
            ...
            if (ois ==null) {
                throw new IllegalArgumentException(
                        "Specified ObjectInputStream class is not instantiable!" );
            }
